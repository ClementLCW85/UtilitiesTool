...
- `docs/context-engineering/ARCHITECTURE.md`: Architecture and current feature state.
- `.github/copilot-instructions.md`: Operational rules for development.
...
4. Ensure implementation details align with `docs/context-engineering/ARCHITECTURE.md`.
5. Follow the workflow rules in `.github/copilot-instructions.md` (e.g., updating feature logs).
