...
**Description:**  
Admin interface to generate a comprehensive PDF report containing all monthly bills, all units status, all payments by units with date/time, all collection rounds, and all unclaimed funds. Report includes generation date/time and is automatically emailed to admin email (***REMOVED***).
...
- [x] PDF is automatically emailed to admin email (***REMOVED***).
